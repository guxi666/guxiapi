	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/lottery/config", controller.GetLotteryConfig)
				selfRoute.POST("/lottery/draw", middleware.CriticalRateLimit(), controller.LotteryDraw)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/manage_batch", controller.ManageUsersBatch)
		...
		{
			lotteryAdminRoute.GET("/config", controller.AdminGetLotteryConfig)
			lotteryAdminRoute.PUT("/config", controller.AdminUpdateLotteryConfig)
			lotteryAdminRoute.GET("/prizes", controller.AdminGetLotteryPrizes)
			lotteryAdminRoute.POST("/prizes", controller.AdminCreateLotteryPrize)
			lotteryAdminRoute.PUT("/prizes", controller.AdminUpdateLotteryPrize)
			lotteryAdminRoute.DELETE("/prizes/:id", controller.AdminDeleteLotteryPrize)
			lotteryAdminRoute.GET("/records", controller.AdminGetLotteryRecords)
		}
