...
const EditRedemptionModal = (props) => {
  ...
  const loadRedemption = async () => {
    ...
    if (success) {
      ...
      data.usage_mode = data.usage_mode || 1;
      if (data.usage_mode === 1) {
        data.max_use_count = 1;
      } else if (data.max_use_count == null) {
        data.max_use_count = 0;
      }
  ...
  const submit = async (values) => {
    ...
    localInputs.usage_mode = parseInt(localInputs.usage_mode) || 1;
    localInputs.max_use_count = parseInt(localInputs.max_use_count) || 0;
    if (localInputs.usage_mode === 1) {
      localInputs.max_use_count = 1;
    }
                  ...
                  <Row gutter={12}>
                    ...
                    <Col span={24}>
                      <Form.Select
                        ...
                        label={t('使用模式')}
                        optionList={[
                          { label: t('全局一次性'), value: 1 },
                          { label: t('多用户单次（每用户一次）'), value: 2 },
                        ]}
                        style={{ width: '100%' }}
                      />
                    </Col>
