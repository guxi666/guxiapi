...
func InitOptionMap() {
	...
	common.OptionMap["USDExchangeRateAutoUpdateEnabled"] = strconv.FormatBool(operation_setting.USDExchangeRateAutoUpdateEnabled)
	common.OptionMap["USDExchangeRateSyncMinutes"] = strconv.Itoa(operation_setting.USDExchangeRateSyncMinutes)
	...
	common.OptionMap["LotteryTitle"] = "幸运抽奖"
	common.OptionMap["LotterySubtitle"] = "每个用户 / 设备 / IP 仅可参与一次"
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "USDExchangeRateAutoUpdateEnabled":
			operation_setting.USDExchangeRateAutoUpdateEnabled = boolValue
		}
	}
	switch key {
	...
	case "USDExchangeRateSyncMinutes":
		operation_setting.USDExchangeRateSyncMinutes, _ = strconv.Atoi(value)
	case "MinTopUp":
